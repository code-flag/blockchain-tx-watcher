...
const submitTXN = async (address_to, amount, privateKey) => {
    ...
    console.log("Address to : "+ address_to, "Amount : "+amount);
   ...
   const submitTXNWithContract = async (address_to, amount, contractAddress, privateKey)  => {
    console.log("argument", [address_to, amount, contractAddress, privateKey]);
    ...
    try {
       ...
       console.log("GAS Limit : ", gasLimit);
        ...
        return {transaction_hash: txHash, transaction_receipt: receipt};
